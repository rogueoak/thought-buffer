...
Thought Stream is a hands-free, on-device dictation thoughts app for iPhone and CarPlay. You start
a stream, talk, pause to think, and edit by voice with a control word (default "Mira"), so you
never have to touch the screen. Speech-to-text runs entirely on device; thoughts are Markdown files
